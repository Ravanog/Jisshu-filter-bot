...
# Owners 
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7253187871 8075224687 6566268406').split()]
...
# Database Channel 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002447436146 -1002680514859 -1002515386092 -1001603505179 -1002217495448').split()]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002283516790'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002283516790'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002119063158'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002220189899')) 
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002160199316'))
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'kushal')
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002297005508')) 

# Added Link Here Not Id 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+_kU_e_VpRp80Nzc1')
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+_kU_e_VpRp80Nzc1')

# Verification
IS_VERIFY = is_enabled('IS_VERIFY', False)
TUTORIAL = environ.get("TUTORIAL", "https://t.me/TG_Bots_Support/234")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/TG_Bots_Support/234")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/TG_Bots_Support/234")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "d1cae2ed2878c0293eb31b043f8846c9881d8bee")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'linkmonetizer.in')
SHORTENER_API2 = environ.get("SHORTENER_API2", "d1cae2ed2878c0293eb31b043f8846c9881d8bee")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'linkmonetizer.in')
SHORTENER_API3 = environ.get("SHORTENER_API3", "d1cae2ed2878c0293eb31b043f8846c9881d8bee")
...
START_IMG = (environ.get('START_IMG', 'https://envs.sh/WtM.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/Wt6.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/WtV.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://lazyprincessbot-kushalhari189.koyeb.app/")
